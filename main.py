...
from opengl_clifford_attractor import CliffordAttractorShader

# TODO : Securiser les fenêtres individuelles pour gestion de crash 
...
if __name__ == "__main__":
    ...
    player4 = PlayerOpenGl(CliffordAttractorShader, titre="OpenGL Random Color", death=1000000)
    player4.show()
